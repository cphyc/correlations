...
A = -xi00p / r
B = (
    sqrt(2) * sin(phimphi / 2) ** 4 * xi00p / (R * (1 - cos(phimphi)) ** (3 / 2))
            ...
            [
                [
                    ...
                    * (
                        ...
                        * (2 + cos(phi1 + phi2))
                        * xi00p
                        / (sqrt(1 + cos(phi1 + phi2)))
                        + 2 * R
                        + cos(phi1 + phi2) * xi00pp
                    ),
                ],
                [
                    1
                    ...
                    * sin(phi2)
                    * sin(phi1 + phi2)
                    * (-sqrt(2) * xi00p / sqrt(1 + cos(phi1 + phi2)) + 2 * R * xi00pp),
                    _0,
                ],
            ],
            [
                ...
                [
                    ...
                    * (
                        ...
                        * R
                        * (
                            3 * sqrt(1 + cos(phi1 + phi2)) * xi00pp
                            + sqrt(2) * R * (-1 + cos(phi1 + phi2)) * xi00ppp
                        )
                    ),
                ],
            ],
